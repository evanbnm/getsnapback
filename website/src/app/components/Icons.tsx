...
export const LinuxIcon = (p: P) => (
  <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" fillRule="evenodd" clipRule="evenodd" {...p}>
    <path d="M12 1.5c-2.1 0-3.3 1.8-3.3 4 0 .9.2 1.8.4 2.6-1.4.5-2.6 1.8-2.6 3.6 0 1.2.5 2.2 1.3 2.9-.8 1.4-1.3 3-1.3 4.5 0 2.3 1.7 3.4 5.5 3.4s5.5-1.1 5.5-3.4c0-1.5-.5-3.1-1.3-4.5.8-.7 1.3-1.7 1.3-2.9 0-1.8-1.2-3.1-2.6-3.6.2-.8.4-1.7.4-2.6 0-2.2-1.2-4-3.3-4Zm-1.6 4.7a.85 1 0 1 0 0 2 .85 1 0 1 0 0-2Zm3.2 0a.85 1 0 1 0 0 2 .85 1 0 1 0 0-2Z" />
    <path d="M12 11.5c-1 0-1.8.5-1.8 1.2 0 .5.4.9 1 1l-.5 1.5h2.6l-.5-1.5c.6-.1 1-.5 1-1 0-.7-.8-1.2-1.8-1.2Z" />
  </svg>
);
