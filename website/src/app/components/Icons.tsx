...
export const LinuxIcon = (p: P) => (
  <svg width="14" height="15" viewBox="0 0 24 24" fill="currentColor" {...p}>
    <path d="M12 2c-2 0-3.4 1.6-3.4 4.3 0 1.3.4 2.2.4 3.3 0 1.3-2.3 3.4-2.3 6.8 0 3.4 2.4 5.1 5.3 5.1s5.3-1.7 5.3-5.1c0-3.4-2.3-5.5-2.3-6.8 0-1.1.4-2 .4-3.3C15.4 3.6 14 2 12 2Zm-1.2 5.4c.6 0 1 .5 1 1.1s-.4 1-1 1-1-.5-1-1 .4-1.1 1-1.1Zm2.4 0c.6 0 1 .5 1 1.1s-.4 1-1 1-1-.5-1-1 .4-1.1 1-1.1Z" />
  </svg>
);
